  ...
  return (
    <div>
      <div className="flex flex-col gap-6 px-3 p-28 max-w-6xl mx-auto">
        ...
        <p className='text-gray-500 text-xs sm:text-sm'>Here you will find a variety of articles and short tutorials on topics mostly related to machine learning, web development, programming, and theoretical Computer Science.</p>
